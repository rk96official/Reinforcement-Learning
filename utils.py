import pandas as pd
import random
from score.embeddings import *

def parameters():
    """ configuration for RL agent """
    
    config = {}
    config['log_file'] = 'predefined_conversations.csv' #file with conversation
    config['nlu'] = 'rasa'
...
def score_data(file='./score/short_corrected.csv', thre_augm = 0.9):
    ...
    bad_resp = "Sorry, I can't help you with that."
